...
<Dates
  updatedAt={documentProps.updatedAt}
  createdAt={documentProps.createdAt}
/>
...
<a
  target="_blank"
  rel="noreferrer"
  href="https://github.com/preactjs/signals/blob/main/packages/preact/README.md#utility-components-and-hooks"
>
  `signal-utils`
</a>
like `Show` and `For`.
...
const TodoSummary = () => (
  <div>
    ...
    <progress value={todoList.completedCount} max={todoList.count} />
  </div>
)
```
...
_Ready to try Preact Signals in your next project? Check out the <a target="_blank" rel="noreferrer" href="https://preactjs.com/guide/v10/signals">official documentation</a> and start building._
