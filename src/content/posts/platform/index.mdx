import WaterfallDiagram from '../../../islands/platform/WaterfallDiagram'
...
it needs: stylesheets, scripts, images. The browser is already doing parallel loading, by default.
...
You get the benefits of SSR (fast HTML delivery, progressive enhancement) with the benefits of a SPA (fast client-side navigation).
...
This is where **persisted operations** (also called trusted documents) come in, read more about it in [my other post](/blog/persisted-operations).
