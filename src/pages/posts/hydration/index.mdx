export const documentProps = {
  ...
  description: 'We see a lot of talk about hydration, what is it and where is it applied?',
...
Tools pioneering this approach are [Astro](https://astro.build/) and [Fresh](https://fresh.deno.dev/), they are definitley worth checking out
...
my minimalism is even starting to distrub me...
