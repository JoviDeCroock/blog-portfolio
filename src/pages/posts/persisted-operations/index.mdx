...
This however already has a few solution in GraphQL. The core principle of this approach is that
...
and in Apollo we have a similar principle in [Automatic Persisted Queries](https://www.apollographql.com/docs/apollo-server/performance/apq/).
