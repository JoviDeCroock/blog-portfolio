...
we can specify dimensions to our `url` which will influence what kidn of URL our server
returns.
...
[two directives named argumetns and argumentDefinitions](https://relay.dev/docs/api-reference/graphql-and-directives/#arguments).
