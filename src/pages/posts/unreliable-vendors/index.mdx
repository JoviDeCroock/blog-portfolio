...
One last thing we can do is optimise for reproduction, an unreliable vendor does not
neccesarily go down... They might just introduce a bug in their systems that starts
behaving unexpectedly. For this case I have personally started thinking about optimising
for reproductions.
