...
<img src='/useId.jpg' alt="Diagram showing a root-node which has a base-id of 1, this node has two children which respectively map to 1.1 and 1.2, 1.1 has 1 child becoming 1.1.1 and 1.2 has two children 1.2.1 and 1.2.2 respectively" />
