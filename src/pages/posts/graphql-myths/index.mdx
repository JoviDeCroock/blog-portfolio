...
Persisted operations offer additional performance advantages. When operations have a consistent, small size (hash plus variables),
...
Persisted operations are straightforward to implement with mature tooling support across Apollo, Relay, urql, and other GraphQL clients.
