import StateEquality from '../../components/vdom-compilers/State-Equality.tsx'
...
optmizations that are easy to miss in Virtual DOM. We often get told to leverage `shouldComponentUpdate` or `memo`.
